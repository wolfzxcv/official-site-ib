...
export const feature: Feature = {
  ...
  WCGMarketsWillProvide:
    'WCG MARKETS 會免費提供 MAM 多帳戶管理員系統 讓合作夥伴可以有效且精確地為多個個人帳戶配置交易條件，將同樣的交易條件及策略，根據預設的比例平均分配至個別帳戶，協助管理交易活動並提升管理技巧。',
  ...
  UnionPayOnline: '銀聯，網銀轉帳，USDT，電匯，全方位支持。',
  MultiFacetedPromotional: '多方向宣傳資源',
  ThePartnersOfWCGMarkets:
    'WCG MARKETS 的合作夥伴可享有公司龐大的資源共享，可按自身的發展模式找到適合的事業藍圖。'
};
