  ...
  const data: InfoAccordionItemProps[] = [
    ...
    },
    {
      ...
      content: [
        ...
        `1. To determine, record and approve the general policy principles of the WCG Markets (HK) Limited in relation to the prevention of Money Laundering and Terrorist Financing and communicate them to the AMLCO.`,
        `2. To appoint the AMLCO and, where necessary, additional assistant AMCLOs and determine their duties and responsibilities, which are recorded in this Manual.`,
        ...
        `7. To establish a clear and quick reporting chain based on which information regarding suspicious transactions is passed without delay to the AMLCO, either directly or through his assistants, if any, and notifies accordingly the AMLCO for its explicit prescription in the Manual.`,
        `8. To ensure that the AMLCO and the Head of Administration/Back-Office Department have sufficient resources, including competent staff and technological equipment, for the effective discharge of their duties.`
      ]
    },
    {
      title:
      ...
      content: [
        ...
        `4. To provide advice and guidance to the employees of the WCG Markets (HK) Limited on subjects related to Money Laundering and Terrorist Financing.`,
    ...
    },
    {
      ...
      content: [
        ...
        `1. Recognizes that the money laundering or terrorist financing threat varies across Clients, countries, services and financial instruments.`,
        `2. Allows the Board to differentiate between Clients of the WCG Markets (HK) Limited in a way that matches the risk of their particular business.`,
        `3. Allows the Board to apply its own approach in the formulation of policies, procedures and controls in response to the WCG Markets (HK) Limited's particular circumstances and characteristics.`,
        ...
        `1. Identifying and assessing the Money Laundering and Terrorist Financing risks emanating from particular Clients or types of Clients, financial instruments, services, and geographical areas of operation of its clients.`,
        ...
        `3. The nature (e.g. non face-to-face) and economic profile of Clients as well as of financial instruments and services offered.`,
        `4. The volume and size of transactions.`,
        `5. The origin and destination of Clients' funds.`,
        `6. The nature of business transactions.`
      ]
    },
    {
      ...
      content: [
        ...
        `1. Office of Foreign Assets Control - http://www.treasury.gov/ofac/downloads/t11sdn.pdf`,
        `2. HM Treasury - 
        ...
        `4. FATF - https://www.fatf-gafi.org/`
      ]
    },
    {
      ...
      content: [
        ...
        `1. The WCG Markets (HK) Limited shall obtain the following information to ascertain the true identity of the natural persons:`,
        ` a. True name and/or names used as these are stated on the official identity card or passport.`,
        ` b. Full permanent address, including postal code, as reflected from any of the following documents:`,
        ` i. Utility bills linked to their residential address.`,
        ` ii. Official bank statements.`,
        ` c. Telephone (home and mobile) and fax numbers`,
        ` d. E-mail address, if any`,
        ` e. Date and place of birth`,
        ` f. Nationality`,
        ` g. Details of the profession and other occupations of the Client including the name of employer/business organization, if necessary, in the events of conflicting information.`,
        `2. In order to verify the Client's identity/name WCG Markets (HK) Limited shall request the Client to present an original document which is issued by an independent and reliable source that carries the Client's photo (e.g., Passport, National Identity cards, Driving License). After WCG Markets (HK) Limited is satisfied for the Client's identity from the original identification document presented, it will keep copies. It is provided that, WCG Markets (HK) Limited shall be able to prove that the said document is issued by an independent and reliable source. In this respect, the AMLCO shall be responsible to evaluate the independence and reliability of the source and shall duly document and file the relevant data and information used for the evaluation, as applicable.`,
        `3. The Client's permanent address shall be verified using one of the following ways:`,
        ` a. Visit at the place of residence (in such a case, WCG Markets (HK) Limited employee who carries out the visit prepares a memo which is retained in the Client's file)`,
        ...
        ` c. Mailing an official letter from the WCG Markets (HK) Limited to the Client's permanent address where a scanned copy of the letter content is required for confirmation`,
    ...
    },
    {
      ...
      content: [
        `i. Transactions with no discernible purpose or are unnecessarily complex.`,
        `ii. Use of foreign accounts of companies or group of companies with complicated ownership structure which is not justified based on the needs and economic profile of the Client.`,
        `iii. The transactions or the size of the transactions requested by the Client do not comply with his usual practice and business activity.`,
        `iv. Large volume of transactions and/or money deposited or credited into, an account when the nature of the Client's business activities would not appear to justify such activity.`,
        `v. The Business Relationship involves only one transaction, or it has a short duration.`,
        `vi. There is no visible justification for a client using the services of a particular financial organization, e.g., the Client is situated far away from the particular financial organization and in a place where he could be provided services by another financial organization.`,
        `vii. There are frequent transactions in the same financial instrument without obvious reason and in conditions that appear unusual (churning).`,
        `viii. There are frequent small purchases of a particular financial instrument by a Client who settles in cash, and then the total number of the financial instrument is sold in one transaction with settlement in cash or with the proceeds being transferred, with the Client's instructions, in an account other than his usual account.`,
        `ix. Any transaction the nature, size or frequency appear to be unusual, e.g. cancellation of an order, particularly after the deposit of the consideration.`,
        `x. Transactions which are not in line with the conditions prevailing in the market, in relation, particularly, with the size of the order and the frequency.`,
        `xi. The settlement of any transaction but mainly large transactions, in cash.`,
        `xii. Settlement of the transaction by a third person which is different than the Client which gave the order.`,
        `xiii. Instructions of payment to a third person that does not seem to be related with the instructor.`,
        `xiv. Transfer of funds to and from countries or geographical areas which do not apply, or they apply inadequately FATF's recommendations on Money Laundering and Terrorist Financing.`,
        `xv. A Client is reluctant to provide complete information when establishes a Business Relationship about the nature and purpose of its business activities, anticipated account activity, prior relationships with financial organizations, names of its officers and directors, or information on its business location. The Client usually provides minimum or misleading information that is difficult or expensive for the financial organization to verify.`,
        `xvi. A Client provides unusual or suspicious identification documents that cannot be readily verified.`,
        `xvii. A Client's home/business telephone is disconnected.`,
        `xviii. A Client that makes frequent or large transactions and has no record of past or present employment experience.`,
        `xix. Difficulties or delays on the submission of the financial statements or other identification documents, of a Client/legal person.`,
        `xx. A Client who has been introduced by a foreign financial organization; or by a third person whose countries or geographical areas of origin do not apply, or they apply inadequately FATF's recommendations on Money Laundering and Terrorist Financing.`,
        `xxi. Shared address for individuals involved in cash transactions, particularly when the address is also a business location and/or does not seem to correspond to the stated occupation (e.g. student, unemployed, self- employed)`,
        `xxii. The stated occupation of the Client is not commensurate with the level or size of the executed transactions.`,
        `xxiii. Financial transactions from non-profit or charitable organizations for which there appears to be no logical economic purpose or in which there appears to be no link between the stated activity of the organization and the other parties in the transaction.`,
        `xxiv. Unexplained inconsistencies arising during the process of identifying and verifying the Client (e.g. previous or current Hong Kong of residence, Hong Kong of issue of the passport, countries visited according to the passport, documents furnished to confirm name, address and date of birth).`,
        `xxv. Complex trust or nominee network.`,
        `xxvi. Transactions or WCG Markets (HK) Limited structures established or working with an unneeded
        ...
        `,
        `xxviii. Changes in the lifestyle of employees of the financial organization, e.g., luxurious way of life or avoiding being out of office due to holidays.`,
        `xxix. Changes in the performance and the behavior of the employees of the financial organization.`
      ]
    },
    {
      ...
      content: [
        ...
        `2. The details of all relevant records with respect to the provision of financial services to Clients.`,
    ...
    },
    {
      ...
      content: [
        `1. WCG Markets (HK) Limited's employees shall be personally liable for failure to report information or suspicion, regarding money laundering or terrorist financing.`,
        ...
        `3. According to the Law, WCG Markets (HK) Limited's employees shall fulfil their legal obligation to report their suspicions regarding Money Laundering and Terrorist Financing, after their compliance with point (2) above.`
      ]
    },
    {
      title: 'Education and Training Policy',
      content: [
        `1. The AMLCO shall ensure that its employees are fully aware of their legal obligations according to the Law, by introducing a complete employees' education and training program.`,
        ...
        `3. The training program aims at educating the WCG Markets (HK) Limited's employees on the latest developments in the prevention of Money Laundering and Terrorist Financing, including the practical methods.`
      ]
    }
  ];
